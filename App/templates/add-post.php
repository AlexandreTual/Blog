...
<form action="index.php?p=add-post" method="post">
    <?=$form->input('Titre', 'title', ['type' => 'text'],false, null, true)?>
    <?=$form->input('Chapô', 'chapo', ['type' => 'textarea'],false, null, true)?>
    <?=$form->input('Contenu de l\'article', 'content', ['type' => 'textarea'],false, null, true, 7)?>
